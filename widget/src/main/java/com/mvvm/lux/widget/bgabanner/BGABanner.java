package com.mvvm.lux.widget.bgabanner;
...
import com.mvvm.lux.widget.bgabanner.transformer.BGAPageTransformer;
import com.mvvm.lux.widget.bgabanner.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointDrawableResId = R.drawable.shape_dots_default;
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mPointLeftRightMargin = DisplayUtil.dp2px(context, 3);
        mPointTopBottomMargin = DisplayUtil.dp2px(context, 6);
        mPointContainerLeftRightPadding = DisplayUtil.dp2px(context, 10);
        mTipTextSize = DisplayUtil.sp2px(context, 10);
        mPointContainerBackgroundDrawable = new ColorDrawable(Color.parseColor("#44aaaaaa"));
        mTransitionEffect = TransitionEffect.Default;
        mNumberIndicatorTextSize = DisplayUtil.sp2px(context, 10);
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.shape_dots_default);
    ...
    public void showPlaceholder() {
        if (mPlaceholderIv == null && mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = Utils.getItemImageView(getContext(), mPlaceholderDrawableResId);
    ...
    public void setData(@DrawableRes int... resIds) {
        ...
        for (int resId : resIds) {
            views.add(Utils.getItemImageView(getContext(), resId));
        }
        setData(views);
    }
    ...
    public void setTransitionEffect(TransitionEffect effect) {
        ...
        if (mViewPager != null) {
            initViewPager();
            if (mHackyViews == null) {
                Utils.resetPageTransformer(mViews);
            } else {
                Utils.resetPageTransformer(mHackyViews);
            }
        }
    }
