...
import com.mvvm.lux.framework.manager.dialogs.interfaces.IListDialogListener;
import com.mvvm.lux.framework.manager.dialogs.interfaces.IMultiChoiceListDialogListener;
...
public class ListDialogFragment extends BaseDialogFragment {
    ...
    public static SimpleListDialogBuilder createBuilder(BaseTask baseTask) {
        return new SimpleListDialogBuilder(baseTask);
    }
    ...
    public static class SimpleListDialogBuilder extends BaseDialogBuilder<SimpleListDialogBuilder> {
        ...
        public SimpleListDialogBuilder(BaseTask baseTask) {
            super(baseTask.getContext(),baseTask.getFragmentManager(), ListDialogFragment.class);
        }
