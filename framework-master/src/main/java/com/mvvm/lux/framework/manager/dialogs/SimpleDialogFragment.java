...
import com.mvvm.lux.framework.manager.dialogs.interfaces.INegativeButtonDialogListener;
import com.mvvm.lux.framework.manager.dialogs.interfaces.INeutralButtonDialogListener;
import com.mvvm.lux.framework.manager.dialogs.interfaces.IPositiveButtonDialogListener;
...
public class SimpleDialogFragment extends BaseDialogFragment {
    ...
    protected final static String PROGRESS_TYPE = "progress_type";


    public static SimpleDialogBuilder createBuilder(BaseTask baseTask) {
        return new SimpleDialogBuilder(baseTask, SimpleDialogFragment.class);
    }
    ...
    public static class SimpleDialogBuilder extends BaseDialogBuilder<SimpleDialogBuilder> {
        ...
        protected SimpleDialogBuilder(BaseTask baseTask, Class<? extends SimpleDialogFragment> clazz) {
            super(baseTask.getContext(), baseTask.getFragmentManager(), clazz);
        }
